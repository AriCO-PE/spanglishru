  ...
  const translations = {
    "ru": {
      ...
      "sections": {
        ...
        "history_text": "Мы — группа молодых латиноамериканцев, увлечённых испанским языком и культурой. Приехав в Россию, мы обнаружили большой интерес к изучению испанского, но заметили, что многие курсы сосредоточены на слишком формальном языке. Поэтому мы создали Spanglish — пространство, где студенты изучают аутентичный, практичный и культурно обогащённый испанский..",
